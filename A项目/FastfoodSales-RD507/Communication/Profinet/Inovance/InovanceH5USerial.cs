...
namespace Communication.Profinet.Inovance
{
	...
	/// </summary>
	/// <remarks>
	/// <inheritdoc cref="InovanceH5UTcp" path="remarks"/>
	/// </remarks>
	public class InovanceH5USerial : ModbusRtu
	{
		...
		public InovanceH5USerial(byte station = 0x01) : base(station) { }

		#endregion

		#region Read Write Override

		/// <inheritdoc cref="InovanceH5UTcp.Read(string, ushort)"/>
		...
		/// <inheritdoc cref="InovanceH5UTcp.Write(string, byte[])"/>
		...
		/// <inheritdoc cref="InovanceH5UTcp.ReadBool(string, ushort)"/>
		...
		/// <inheritdoc cref="InovanceH5UTcp.Write(string, bool[])"/>
		...
		/// <inheritdoc cref="InovanceH5UTcp.Write(string, short)"/>
		...
		/// <inheritdoc cref="InovanceH5UTcp.Write(string, ushort)"/>
		...
		/// <inheritdoc/>
		public override string ToString() => $"InovanceH5USerial[{PortName}:{BaudRate}]";
