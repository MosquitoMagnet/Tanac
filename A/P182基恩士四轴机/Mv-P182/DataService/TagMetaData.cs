...
namespace DataService
{
    ...
    public class TagMetaData : IComparable<TagMetaData>
    {
        ...
        public SeverityType Severity { get; set; }//报警程度
        public string Code { get; set; }//报警代码

        public string DtCode { get; set; }//ICT AutoDT报警代码
        [Browsable(false)]
        public short GroupID { get; set; }

        public TagMetaData(short id, short grpId, string name, string address, SeverityType severity,string code,string dtcode,
