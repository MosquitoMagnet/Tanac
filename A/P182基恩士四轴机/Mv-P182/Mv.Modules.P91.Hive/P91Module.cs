...
using Mv.Modules.P91.Hive.Views.Dialogs;
using Mv.Modules.P91.Hive.Views.Messages;
using Mv.Ui.Core;
...
namespace Mv.Modules.P91.Hive
{
    [Module(ModuleName = "P91")]
    public class P91Module : ModuleBase
    {
        private readonly IRegionManager _regionManager;

        public P91Module(IUnityContainer container, IRegionManager regionManager) : base(container)
        {
