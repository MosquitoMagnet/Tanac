...
namespace CommonDriver.Modbus
{
    ...
    public class ModbusAsciiDriver : DriverInitBase, IPLCDriver, IMultiReadWrite
    {
        ...
        public ModbusAsciiDriver(IDataServer server, short id, string name, string serverName, int timeOut = 10000, IDictionary<string, string> paras = null)
