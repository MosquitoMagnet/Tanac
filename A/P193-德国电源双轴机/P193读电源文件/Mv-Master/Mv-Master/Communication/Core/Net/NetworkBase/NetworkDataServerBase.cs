...
namespace Communication.Core.Net
{
	...
	public class NetworkDataServerBase : NetworkAuthenticationServerBase, IDisposable, IReadWriteNet
	{
		...
		protected void RaiseDataReceived(byte[] receive) => OnDataReceived?.Invoke(this, receive);
		...
		protected void RaiseDataSend(byte[] receive) => OnDataSend?.Invoke(this, receive);
