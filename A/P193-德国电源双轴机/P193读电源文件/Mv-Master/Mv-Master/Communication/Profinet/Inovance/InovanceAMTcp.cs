...
namespace Communication.Profinet.Inovance
{
	...
	public class InovanceAMTcp : ModbusTcpNet
	{
		...
		public InovanceAMTcp(string ipAddress, int port = 502, byte station = 0x01) : base(ipAddress, port, station) { }
		...
		/// <inheritdoc/>
		public override string ToString() => $"InovanceAMTcp[{IpAddress}:{Port}]";
