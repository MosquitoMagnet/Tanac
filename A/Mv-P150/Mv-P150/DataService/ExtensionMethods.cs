    ...
    public static class ExtMethods
    {
        ...
        public static bool ModifyItemName(this ITag tag, string name)
        {
            ...
            lock (server.SyncRoot)
            {
                ...
                server.MetaDataList[index] = new TagMetaData(meta.ID, meta.GroupID, name, meta.Address, meta.Severity, meta.Code,meta.DtCode,meta.DataType, meta.Size, meta.Archive, meta.Maximum, meta.Minimum, meta.Cycle);
